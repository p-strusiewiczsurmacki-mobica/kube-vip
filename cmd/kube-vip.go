...
func init() {
	...
	kubeVipCmd.PersistentFlags().StringVar(&initConfig.DebounceTime, "debounceTime", debouncer.DefaultTime, "Configures the time that the event debouncer will wait for the events arrival (min. 200ms)")
