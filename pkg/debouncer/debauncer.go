...
// debauncer will spawn a debounce goroutine for eah object in namespace
...
// ns object represents kubernetes namespace with debbouncer routine per object
type ns struct {
	sync.Map
	cnt atomic.Int64
}
